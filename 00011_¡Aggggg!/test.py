class Test(unittest.TestCase):
  ...
  def test_genera_el_DataFrame_correcto(self):
    ...
    self.assertTrue(indexados.loc["Buenos Aires", "sector"] == 1, "debe tener el valor correcto para Buenos Aires")
    self.assertTrue(indexados.loc["Santa Fe", "sector"] == 0.8, "debe tener el valor correcto para Santa Fe")
